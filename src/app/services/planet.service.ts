...
export class PlanetService {
  ...
  getPlanets(): Observable<Planet[]> {
    return this.http
      .get<Planet[]>(this.apiURL,this.httpOptions)
  ...
  removePlanet(planet: Planet) {
    this.planets = this.planets.filter(
      (planetToRemove) => planetToRemove !== planet
    );
    return this.planets;
  }
}
